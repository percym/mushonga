...
@Entity
@Table(schema = "static", name = "permissions")
//@AttributeOverrides({
//        @AttributeOverride(name = "id", column = @Column(name = "permissions_serial"))
//})
@SequenceGenerator(name = "default_seq", schema = "data", sequenceName = "permissions_serial_seq", allocationSize = 1)
public class Permissions implements IPermissions,Serializable{

...
import systems.health263.dashboard.model.permissions.PermissionsConsumption;
...
public class Group implements IGroup<PermissionsConsumption>,Serializable {
    ...
    @Valid
    @ManyToMany(cascade = CascadeType.ALL,targetEntity = PermissionsConsumption.class,fetch = FetchType.EAGER)
    private Collection<PermissionsConsumption> permissions;
    ...
    @Override
    public Collection<PermissionsConsumption> getPermissions() {
        return permissions;
    }

    @Override
    public void setPermissions(Collection<PermissionsConsumption> permissions) {

...
public class GroupController {
    ...
    /**
     * GET  /group: get all the groups paginated.
     *
     * @param pageable the pagination information
     * @return the ResponseEntity with status 200 (OK) and the list of bill in body
     */
    @GetMapping("/group_paged")
    @Timed
    public ResponseEntity<List<Group>> getAllGroupPaged(Pageable pageable) {
    ...
    /**
     * GET  /group/:id : get the group by "id" .
     *
    ...
    /**
     * SEARCH  /_search/group?query=:query : search for the bill corresponding
     * to the query.
     *
